...
class Constants {
    ...
    public static final String KEY_VIB_RING = "keyVibRing";
    public static final String KEY_DAILY_NOTIF = "keyDailyNotif";
    public static final String KEY_TTS = "keyTTSstate";
